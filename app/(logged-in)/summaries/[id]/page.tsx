...
export default async function SummaryPage(props: {
  ...
  const { title, summary_text, file_name, fileUrl ,word_count, reading_time} = summary;
    ...
    <div className="realtive isolate min-h-screen bg-linear-to-r from-purple-50/40 to-white">
      ...
      <div className="container mx-auto flex flex-col gap-4">
        <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-12 lg:py-24">
          ...
          {file_name && <SourceInfo title={title} summaryText={summary_text} file_name={file_name} original_file_url={fileUrl} createdAt={summary.created_at} />}
