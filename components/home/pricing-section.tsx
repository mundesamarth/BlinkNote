    ...
    <div className="relative w-full max-w-lg hover:scale-105 hover:transition-all duration-300">
      ...
      >
        ...
        <div className="space-y-2 flex justify-center w-full">
          <Link
            href={paymentLink}
            className={cn("w-full rounded-full flex items-center justify-center gap-2 bg-linear-to-r from-purple-800 to-purple-500 hover:from-purple=500 hover:to-purple-800 text-white border-2 py-2",
                id === "pro" ? 'border-purple-900':'border-purple-100 from-purple-400 to-purple-500'
            )}
          >
