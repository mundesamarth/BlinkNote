...
import { MotionDiv, MotionH2, MotionH3 } from "./motion-wrapper";
...
const steps: Step[] = [
  {
    ...
    description: "Simply drag and drop yourPDF document or click to upload.",
  },
  {
  ...
  return (
    <section className="relative overflow-hidden bg-gray-50 ">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(50%-3rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-linear-to-br from-teal-500 via-yellow-500 to-red-500 opacity-30 sm:left-[calc(40%-30rem)] sm:w-[40.1875rem]"
            style={{
              clipPath:
  ...
  return (
    <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-purple-500/50 transition-colors group w-full">
      <div className="flex items-center gap-2">
        <div className="flex items-center justify-center h-24 w-24 mx-auto rounded-2xl bg-linear-to-br from-purple-500/10 to-transparent group-hover:from-purple-300 group-hover:to-purple-500/2 transition-colors ">
